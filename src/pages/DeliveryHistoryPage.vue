...
// "History" = settled pickups, not the live IN_PROGRESS/ON_ROUTE work — matches
// Jalat-Order-Service/src/graphql/order/order.service.ts's own default-vs-history
// split for getOrderListByUser (empty filter defaults to the live statuses).
const HISTORY_STATUSES = ['PICKED_UP', 'REGISTERED', 'PRINTED', 'ABORT_PICK_UP', 'CANCELLED'] as const;
